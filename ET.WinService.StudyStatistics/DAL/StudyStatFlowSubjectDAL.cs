...
namespace ET.WinService.StudyStatistics.DAL
{
    ...
    /// [示例代码在这里写入]
    /// </example>
    class StudyStatFlowSubjectDAL
    {
        public StudyStatFlowSubjectDAL()
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<StudyStatFlowSubject> GetList()
        {
            ...
            try
            {
                ...
                string selectSql = @"select * from T_StudyStatFlow_Subject";
                ...
                return DataUtil.ToList<StudyStatFlowSubject>(ds.Tables[0]);
            }
            catch (Exception ex)
            {
                throw ex;
