...
namespace ET.WinService.AreaStatistics.DAL
{
    ...
    /// </summary>
    /// <returns></returns>
    public class ParamRoadSegmentsDAL
    {
        /// <summary>
        /// 根据分析组ID获取路段集合信息
        /// </summary>
        /// <param name="AnalyseGroupID"></param>
        /// <returns></returns>
        public List<ParamRoadSegments> GetList(long AnalyseGroupID)
        {
            try
            {
        ...
        /// <param name="db"></param>
        /// <returns></returns>
        public List<ParamRoadSegments> GetList(long AnalyseGroupID, DbTransaction tran, Database db)
        {
            try
            {
                DataSet ds = null;
                ...
                try
                {
                    ...
                    string selectSql = @"select ID,AnalyseGroupID " +
                    "from dbo.ANA_ParamRoadSegments " +
                    ...
                    return DataUtil.ToList<ParamRoadSegments>(ds.Tables[0]);
                }
                catch (Exception ex)
                {
                    throw ex;
